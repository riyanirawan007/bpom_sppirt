...
class Rekap_penerbitan extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('rekap_penerbitan_model');
	...
	public function index()
	{
			...
			return view_dashboard('rekap_penerbitan/view');
	...
	public function get(){
		...
		echo json_encode($this->rekap_irtp->get_penerbitan($params));
	}
	
	public function prov(){
		echo json_encode($this->rekap_irtp->get_prov());
	}
	public function kab(){
		echo json_encode($this->rekap_irtp->get_kab());
	}
	...
	public function rekap(){
		...
		$filename='Rekap Penerbitan IRTP' ;
		if($prov!=''){
			$filename.=' '.$prov_name;
		}
		if($kab!=''){
		...
		$data=$this->rekap_irtp->get_penerbitan($params);
		$i=0;

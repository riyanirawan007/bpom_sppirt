...
class Rekap_pengajuan extends CI_Controller {
	...
	public function index()
	{
			...
			return view_dashboard('rekap_pengajuan/view');
	...
	public function get(){
		...
		echo json_encode($this->rekap_irtp->get_pengajuan($params));
	}
	...
	public function rekap(){
		...
		$data=$this->rekap_irtp->get_pengajuan($params);
		$i=0;

<div class="breadcrumbs" id="breadcrumbs">
	...
	<ul class="breadcrumb">
		...
		<li class="active">Data Rekap Penerbitan SPP-IRT</li>
	</ul>
		...
		<div class="col-xs-12">
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="row">
						<div class="col-xs-4">
							<h3 class="smaller lighter blue">Tabel Rekap Penerbitan SPP-IRT</h3>
						</div>
					...
					<div class="table-header">
						Hasil untuk "Data Rekap Penerbitan"
					</div>

					<div class="table-responsive">

						<table style="font-size:14px;" id="tbl_rkp_irtp_penerbitan" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<th>No</th>
									<th>Provinsi</th>
									<th>Jumlah Penerbitan SPP-IRT Per Provinsi</th>
								</tr>
							</thead>
...
var getPerKab=function(prov_id){
        $.ajax({
            url:'<?php echo base_url();?>'+'rekap/getPenerbitan'
            ,type:'GET'
            ,dataType:'json'
            ,data:{prov:prov_id}
            ,success:function(res)
            {
                var title="Rekap Penerbitan SPP-IRT "+res.data[0].nama_propinsi;
                ...
                <thead>\
					...
					<th>Jumlah Penerbitan SPP-IRT Per Kabupaten</th>\
                </thead><tbody>';
...
$('document').ready(function(){
	...
	$('#tbl_rkp_irtp_penerbitan').dataTable({
		processing:true,
	...
	$('#fsend').click(function(){
		no=0;
		$('#tbl_rkp_irtp_penerbitan').DataTable().ajax.reload();
	});

	$('#report').click(function(){
		window.open(
			'<?php echo base_url();?>rekap/export_penerbitan' +
			'?prov=' + $('#fprov').val() +

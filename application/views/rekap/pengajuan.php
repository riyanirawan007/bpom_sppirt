<div class="breadcrumbs" id="breadcrumbs">
	...
	<ul class="breadcrumb">
		...
		<li class="active">Data Rekap Pengajuan SPP-IRT</li>
	</ul>
		...
		<div class="col-xs-12">
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="row">
						<div class="col-xs-4">
							<h3 class="smaller lighter blue">Tabel Rekap Pengajuan SPP-IRT</h3>
						</div>
					...
					<div class="table-header">
						Hasil untuk "Data Rekap Pengajuan SPP-IRT"
					</div>

					<div class="table-responsive">

						<table style="font-size:14px;" id="tbl_rkp_irtp_pengajuan" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<th>No</th>
									<th>Provinsi</th>
...
var getPerKab=function(prov_id){
        $.ajax({
            url:'<?php echo base_url();?>'+'rekap/getPengajuan'
            ,type:'GET'
            ,dataType:'json'
            ,data:{prov:prov_id}
            ,success:function(res)
            {
                var title="Rekap Pengajuan SPP-IRT "+res.data[0].nama_propinsi;
...
$('document').ready(function(){
	...
	$('#report').click(function(){
		window.open(
			'<?php echo base_url();?>rekap/export_pengajuan' +
			'?prov=' + $('#fprov').val() +

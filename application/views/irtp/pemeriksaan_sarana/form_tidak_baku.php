									...
									<div class="step-content pos-rel">
										<div class="step-pane active" data-step="1">
											...
											<div class="form-group row anggota_form">
												...
												<div class="form-group">
													<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="text">Dokumen Pemeriksaan</label>

													<div class="col-xs-12 col-sm-9">
														<div class="clearfix">
															<input type="file" class="col-xs-12 col-sm-9" name="dokumen" class="form-control pull-left" >
														</div>
													</div>
												</div>

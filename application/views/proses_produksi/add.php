...
<form action="<?= base_url() ?>proses_produksi/add" method="post" onsubmit="return cek_add()">
	<h1>Tambah Proses Produksi</h1>
	<div class="form-group">
		<label for="tek_olah">Proses Produksi : </label>
		<input type="text" class="form-control" name="tek_olah" id="tek_olah" required value="<?=set_value('tek_olah')?>"/>
	</div>

<div class="breadcrumbs" id="breadcrumbs">
	...
	<ul class="breadcrumb">
		...
		<li class="active">Data Rekap Penerbitan</li>
	</ul>
		...
		<div class="col-xs-12">
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="row">
						<div class="col-xs-3">
							<h3 class="smaller lighter blue">Tabel Rekap Penerbitan</h3>
						</div>
					...
					<div class="table-responsive">
						...
						<table id="tbl_rkp_irtp_penerbitan" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<th>No</th>
									<th>Provinsi</th>
...
$('document').ready(function(){
	...
	$('#tbl_rkp_irtp_penerbitan').dataTable({
		processing:true,
		ajax:{
			url:'<?php echo site_url();?>rekap_penerbitan/get',
			type:'GET',
			dataType:'json',
			data:function(e){
				$prov=$('#fprov').val();
	...
	$('#report').click(function(){
		window.open(
			'<?php echo site_url();?>rekap_penerbitan/rekap' +
			'?prov=' + $('#fprov').val() +
			'&kab=' + $('#fkab').val()+
